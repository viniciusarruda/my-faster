...
def see_rpn_results(img_np, table_gts_positive_anchors, proposals_np, probs_object_np, annotation_np, anchors_np, e):
...
def show_anchors(anchors_np, image_size):
...
def show_associated_positive_anchors(img_number, anchors_np, table_gts_positive_anchors_np, annotation_np, image_size):
...
def show_masked_anchors(e, anchors_np, mask_np, table_gts_positive_anchors_np, annotation_np, image_size):

    show_associated_positive_anchors(e, anchors_np, table_gts_positive_anchors_np, annotation_np, image_size)
